...
const NewContent = ({titleNew}) => {
  ...
  return (
      <SectionUI  title={langSelect(lang ,titleNew?.title_ru , titleNew?.title_en ,titleNew?.title_uz )} subTitle={langSelect(lang ,titleNew?.sub_title_ru , titleNew?.sub_title_en ,titleNew?.sub_title_uz )}   isEmbroidery={true}
