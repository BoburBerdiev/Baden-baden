...

            {
                titleSecond ?
                    <div className={' flex items-center gap-3 md:gap-5 lg:gap-7 xl:gap-12'}>
                        ...
                        <CgArrowLongRight className={`text-base sm:text-xl lg:text-2xl ${isInner ? "text-currentBlack":"text-white"}  flex-shrink-0`}/>
                        <div className={'flex items-center gap-5 xl:gap-10'}>
                    ...
                    :
                    <div className={`flex items-center justify-between gap-5 xl:gap-10 ${isInner?"border-[0.5px] border-currentBlue/70 p-[9px_6px]":""}`}>
                        <h5 className={`${isInner ? "text-currentBlack":"text-white"}  text-sm sm:text-base text-center sm:text-start   `}>
                            {title}
                        </h5>
